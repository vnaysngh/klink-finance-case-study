...
export default function Hero() {
  return (
    <>
      <section>
        <div className="bg-primary relative z-[999] min-h-screen overflow-hidden rounded-4xl pb-6 text-white md:pb-12 lg:min-h-[80vh]">
          <Header />

          <div className="mx-auto flex flex-col items-center justify-between px-6 py-12 lg:flex-row lg:px-12">
          ...
          <div className="absolute bottom-8 w-full md:relative md:bottom-5">
            <div className="mx-auto mt-12 px-6 lg:px-12">
          ...
          <video
            className="absolute bottom-[-35%] z-[-1] mx-auto w-full max-w-6xl scale-175 overflow-hidden rounded-br-4xl shadow-lg md:bottom-[-55%] md:scale-100 lg:right-[-20%]"
            autoPlay
            loop
            muted
            playsInline
