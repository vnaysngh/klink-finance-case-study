...
const TokenIntro = ({ isLoaded }: LoadedProps) => {
  return (
      ...
      >
        <h1 className="mb-6 text-4xl font-semibold tracking-[-1px] sm:text-7xl">
          <div className="text-klink-purple relative inline-block">
            $KLINK
            <span className="to-gradient-tertiary/20 from-gradient-secondary/20 absolute -inset-1 block animate-pulse bg-gradient-to-r blur-lg"></span>
          </div>
          <div
        ...
        >
          <button className="border-gradient-primary from-gradient-secondary to-gradient-tertiary rounded-full border bg-gradient-to-r px-4 py-2 text-base font-semibold text-white shadow-[inset_0px_1.15px_20.39px_0px_#FFFFFF6E] transition-all duration-300 hover:scale-105 hover:from-purple-600 hover:to-purple-400 sm:px-6 sm:py-4">
            Buy $KLINK
          </button>
